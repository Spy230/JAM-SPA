        ...
        <div>
          ...
          <div style={{ background: 'rgba(0, 0, 0, 0.5)', borderRadius: '20px', padding: '30px', border: '2px solid rgba(0, 212, 255, 0.3)' }}>
            ...
            <div className="contact-icons">
              <a href="https://wa.me/89253115723" target="_blank" rel="noopener noreferrer" className="contact-icon-btn whatsapp">
              ...
              <a href="https://t.me/89253115723" target="_blank" rel="noopener noreferrer" className="contact-icon-btn telegram">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
